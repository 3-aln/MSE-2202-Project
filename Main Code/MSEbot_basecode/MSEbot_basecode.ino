...
const long CR1_clReadTimeout = 220;
 ...
 uint8_t ci8RightTurn = 24;
 uint8_t ci8LeftTurn = 26;
       ...
       {   
         ...
         switch(ucMotorStateIndex)
         {
           ...
           case 1:
          {
            ...
            CR1_ui8LeftWheelSpeed = (CR1_ui8WheelSpeed-68);
          ...
          case 5:
          {
            ...
            CR1_ui8LeftWheelSpeed = (CR1_ui8WheelSpeed-69);
            CR1_ui8RightWheelSpeed = (CR1_ui8WheelSpeed-70);
            ucMotorStateIndex = 6;
         ...
         //Looking for beaacon now
           ...
           case 9:
          {
            ...
            ucMotorState = 4;                                 //forward 2
            CR1_ui8LeftWheelSpeed = (CR1_ui8WheelSpeed-76);
            CR1_ui8RightWheelSpeed = (CR1_ui8WheelSpeed-80);
